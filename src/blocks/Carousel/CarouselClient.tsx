  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <ul className="-ml-4 flex snap-x snap-mandatory overflow-x-auto scroll-smooth rounded-lg pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden" onScroll={handleScroll} ref={trackRef}>
